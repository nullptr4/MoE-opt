...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel(const int* __restrict__ group_idx_for_bx, const int* __restrict__ group_offsets, const int* __restrict__ group_padded_offsets, const int* __restrict__ group_sizes, const half_t* __restrict__ input, const half_t* __restrict__ routed_expert_gate, const half_t* __restrict__ routed_expert_up, half_t* __restrict__ up_logits) {
  float gate_logits_local[32];
  float up_logits_local[32];
  ...
  for (int k = 0; k < 56; ++k) {
    ...
    for (int i_3 = 0; i_3 < 4; ++i_3) {
      ...
      uint4 condval_5;
      if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
        condval_5 = *(uint4*)(routed_expert_gate + ((((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)458752)) + (((int64_t)i_3) * (int64_t)114688)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)7168)) + (((int64_t)k) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)));
      } else {
      ...
      *(uint4*)(routed_expert_up_shared + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_3 * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_5;
    }
    half_t B_local[16];
    __syncthreads();
    for (int ki = 0; ki < 8; ++ki) {
      for (int j = 0; j < 4; ++j) {
        *(uint2*)(B_local + (j * 4)) = *(uint2*)(routed_expert_up_shared + ((((((((ki >> 2) * 4096) + (j * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
      }
      for (int i_4 = 0; i_4 < 2; ++i_4) {
        for (int j_1 = 0; j_1 < 4; ++j_1) {
          {
      *(((float32x4*)gate_logits_local) + ((i_4 * 4) + j_1)) = __builtin_mxc_mma_16x16x16f16(*(((float16x4*)B_local) + j_1),
                    *(((float16x4*)input_shared) + ((ki * 2) + i_4)),
                    *(((float32x4*)gate_logits_local) + ((i_4 * 4) + j_1)));
    };
        }
      }
    }
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      uint4 condval_6;
      if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
        condval_6 = *(uint4*)(routed_expert_up + ((((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)458752)) + (((int64_t)i_5) * (int64_t)114688)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)7168)) + (((int64_t)k) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)));
      } else {
      ...
      *(uint4*)(routed_expert_up_shared + ((((((((((int)threadIdx.x) & 15) >> 3) * 4096) + (i_5 * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_6;
    }
    half_t B_local_1[16];
    __syncthreads();
    for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
      for (int j_2 = 0; j_2 < 4; ++j_2) {
        *(uint2*)(B_local_1 + (j_2 * 4)) = *(uint2*)(routed_expert_up_shared + ((((((((ki_1 >> 2) * 4096) + (j_2 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_1 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
      }
      for (int i_6 = 0; i_6 < 2; ++i_6) {
        for (int j_3 = 0; j_3 < 4; ++j_3) {
          {
      *(((float32x4*)up_logits_local) + ((i_6 * 4) + j_3)) = __builtin_mxc_mma_16x16x16f16(*(((float16x4*)B_local_1) + j_3),
                    *(((float16x4*)input_shared) + ((ki_1 * 2) + i_6)),
                    *(((float32x4*)up_logits_local) + ((i_6 * 4) + j_3)));
    };
        }
      }
    }
  ...
  for (int i_8 = 0; i_8 < 8; ++i_8) {
    if (((((((int)threadIdx.x) >> 6) * 32) + ((i_8 >> 2) * 16)) + (((int)threadIdx.x) & 15)) < actual_rows) {
      uint2 __1;
      float4 v_ = *(float4*)(up_logits_local + (i_8 * 4));
      ((half2*)(&__1))[0] = __float22half2_rn(((float2*)(&v_))[0]);
      ((half2*)(&__1))[1] = __float22half2_rn(((float2*)(&v_))[1]);
      *(uint2*)(up_logits_local_cast + 0) = __1;
      if (0 <= (((((((int)threadIdx.x) >> 6) * 32) + ((i_8 >> 2) * 16)) + m_start) + (((int)threadIdx.x) & 15))) {
        if ((((((((int)threadIdx.x) >> 6) * 32) + ((i_8 >> 2) * 16)) + m_start) + (((int)threadIdx.x) & 15)) < 131072) {
          *(uint2*)(up_logits + ((((((((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)65536) + ((((int64_t)i_8) >> (int64_t)2) * (int64_t)32768)) + (((int64_t)m_start) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)2048)) + (((int64_t)((int)blockIdx.y)) * (int64_t)64)) + ((((int64_t)i_8) & (int64_t)3) * (int64_t)16)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)4) * (int64_t)4))) = *(uint2*)(up_logits_local_cast + 0);
        }
      }
    }
  }
...
extern "C" __global__ void __launch_bounds__(256, 1) kernel_kernel_1(const int* __restrict__ group_idx_for_bx, const int* __restrict__ group_offsets, const int* __restrict__ group_padded_offsets, const int* __restrict__ group_sizes, half_t* __restrict__ output, const half_t* __restrict__ routed_expert_down, const half_t* __restrict__ routed_expert_weights, const half_t* __restrict__ up_logits) {
  ...
  for (int i_1 = 0; i_1 < 8; ++i_1) {
    ...
    uint4 condval_4;
    if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
      condval_4 = *(uint4*)(routed_expert_down + (((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)262144)) + (((int64_t)i_1) * (int64_t)32768)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)));
    } else {
    ...
    *(uint4*)(routed_expert_down_shared + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_1 * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_4;
  }
  for (int k = 0; k < 15; ++k) {
    #pragma unroll
    for (int i_2 = 0; i_2 < 16; ++i_2) {
      ...
      uint2 condval_5;
      if ((((((((((int)threadIdx.x) >> 6) * 32) + ((i_2 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15)) < 131072) && (0 <= (((((((int)threadIdx.x) >> 6) * 32) + ((i_2 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15))))) {
        condval_5 = *(uint2*)(up_logits + ((((((((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)65536) + ((((int64_t)i_2) & (int64_t)1) * (int64_t)32768)) + (((int64_t)m_start) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)2048)) + (((int64_t)k) * (int64_t)128)) + ((((int64_t)i_2) >> (int64_t)1) * (int64_t)16)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)4) * (int64_t)4)));
      } else {
        condval_5 = make_uint2(__pack_half2(broadcast_var_2, broadcast_var_2), __pack_half2(broadcast_var_2, broadcast_var_2));
      }
      *(uint2*)(up_logits_shared + (i_2 * 4)) = condval_5;
    }
    half_t B_local[32];
    __syncthreads();
    for (int ki = 0; ki < 8; ++ki) {
      for (int j = 0; j < 8; ++j) {
        *(uint2*)(B_local + (j * 4)) = *(uint2*)(routed_expert_down_shared + ((((((((ki >> 2) * 8192) + (j * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
      }
      for (int i_3 = 0; i_3 < 2; ++i_3) {
        for (int j_1 = 0; j_1 < 8; ++j_1) {
          {
      *(((float32x4*)output_local) + ((i_3 * 8) + j_1)) = __builtin_mxc_mma_16x16x16f16(*(((float16x4*)B_local) + j_1),
                    *(((float16x4*)up_logits_shared) + ((ki * 2) + i_3)),
                    *(((float32x4*)output_local) + ((i_3 * 8) + j_1)));
    };
        }
      }
    }
    ...
    for (int i_4 = 0; i_4 < 8; ++i_4) {
      ...
      uint4 condval_6;
      if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
        condval_6 = *(uint4*)(routed_expert_down + (((((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)262144)) + (((int64_t)i_4) * (int64_t)32768)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)4) * (int64_t)2048)) + (((int64_t)k) * (int64_t)128)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)8)) + (int64_t)128));
      } else {
        condval_6 = make_uint4(__pack_half2(broadcast_var_3, broadcast_var_3), __pack_half2(broadcast_var_3, broadcast_var_3), __pack_half2(broadcast_var_3, broadcast_var_3), __pack_half2(broadcast_var_3, broadcast_var_3));
      }
      *(uint4*)(routed_expert_down_shared + ((((((((((int)threadIdx.x) & 15) >> 3) * 8192) + (i_4 * 1024)) + ((((int)threadIdx.x) >> 4) * 64)) + (((((((int)threadIdx.x) & 127) >> 6) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 31) >> 4) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_6;
    }
  }
  #pragma unroll
  for (int i_5 = 0; i_5 < 16; ++i_5) {
    ...
    if ((((((((((int)threadIdx.x) >> 6) * 32) + ((i_5 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15)) < 131072) && (0 <= (((((((int)threadIdx.x) >> 6) * 32) + ((i_5 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15))))) {
      condval_7 = *(uint2*)(up_logits + ((((((((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)65536) + ((((int64_t)i_5) & (int64_t)1) * (int64_t)32768)) + (((int64_t)m_start) * (int64_t)2048)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)2048)) + ((((int64_t)i_5) >> (int64_t)1) * (int64_t)16)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)4) * (int64_t)4)) + (int64_t)1920));
    } else {
  ...
  for (int ki_1 = 0; ki_1 < 8; ++ki_1) {
    for (int j_2 = 0; j_2 < 8; ++j_2) {
      *(uint2*)(B_local_1 + (j_2 * 4)) = *(uint2*)(routed_expert_down_shared + ((((((((ki_1 >> 2) * 8192) + (j_2 * 1024)) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + ((ki_1 & 3) >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
    }
    for (int i_6 = 0; i_6 < 2; ++i_6) {
