  ...
  for (int k = 0; k < 112; ++k) {
    ...
    for (int i_2 = 0; i_2 < 8; ++i_2) {
      ...
      if ((((((((((int)threadIdx.x) >> 6) * 32) + ((i_2 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15)) < 131072) && (0 <= (((((((int)threadIdx.x) >> 6) * 32) + ((i_2 & 1) * 16)) + m_start) + (((int)threadIdx.x) & 15))))) {
        condval_4 = *(uint2*)(input + ((((((((((int64_t)((int)threadIdx.x)) >> (int64_t)6) * (int64_t)229376) + ((((int64_t)i_2) & (int64_t)1) * (int64_t)114688)) + (((int64_t)m_start) * (int64_t)7168)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)15) * (int64_t)7168)) + (((int64_t)k) * (int64_t)64)) + ((((int64_t)i_2) >> (int64_t)1) * (int64_t)16)) + (((((int64_t)((int)threadIdx.x)) & (int64_t)63) >> (int64_t)4) * (int64_t)4)));
      } else {
    ...
    for (int i_3 = 0; i_3 < 4; ++i_3) {
      ...
      uint4 condval_5;
      if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
        condval_5 = *(uint4*)(routed_expert_gate + ((((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)917504)) + (((int64_t)i_3) * (int64_t)229376)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)3) * (int64_t)7168)) + (((int64_t)k) * (int64_t)64)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)7) * (int64_t)8)));
      } else {
      ...
      *(uint4*)(routed_expert_up_shared + (((((i_3 * 2048) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_5;
    }
    half_t B_local[32];
    __syncthreads();
    for (int ki = 0; ki < 4; ++ki) {
      for (int j = 0; j < 8; ++j) {
        *(uint2*)(B_local + (j * 4)) = *(uint2*)(routed_expert_up_shared + ((((((j * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (ki >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
      }
    ...
    for (int i_5 = 0; i_5 < 4; ++i_5) {
      ...
      uint4 condval_6;
      if (((0 <= cur_group_idx) && (cur_group_idx < 8))) {
        condval_6 = *(uint4*)(routed_expert_up + ((((((((int64_t)cur_group_idx) * (int64_t)14680064) + (((int64_t)((int)blockIdx.y)) * (int64_t)917504)) + (((int64_t)i_5) * (int64_t)229376)) + ((((int64_t)((int)threadIdx.x)) >> (int64_t)3) * (int64_t)7168)) + (((int64_t)k) * (int64_t)64)) + ((((int64_t)((int)threadIdx.x)) & (int64_t)7) * (int64_t)8)));
      } else {
      ...
      *(uint4*)(routed_expert_up_shared + (((((i_5 * 2048) + ((((int)threadIdx.x) >> 3) * 64)) + (((((((int)threadIdx.x) & 63) >> 5) + ((((int)threadIdx.x) & 7) >> 2)) & 1) * 32)) + (((((((int)threadIdx.x) & 31) >> 4) + ((((int)threadIdx.x) & 3) >> 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 15) >> 3) + (((int)threadIdx.x) & 1)) & 1) * 8))) = condval_6;
    }
    half_t B_local_1[32];
    __syncthreads();
    for (int ki_1 = 0; ki_1 < 4; ++ki_1) {
      for (int j_2 = 0; j_2 < 8; ++j_2) {
        *(uint2*)(B_local_1 + (j_2 * 4)) = *(uint2*)(routed_expert_up_shared + ((((((j_2 * 1024) + ((((int)threadIdx.x) & 15) * 64)) + (((((((int)threadIdx.x) & 7) >> 2) + (ki_1 >> 1)) & 1) * 32)) + (((((((int)threadIdx.x) & 3) >> 1) + (ki_1 & 1)) & 1) * 16)) + (((((((int)threadIdx.x) & 63) >> 5) + (((int)threadIdx.x) & 1)) & 1) * 8)) + (((((int)threadIdx.x) & 31) >> 4) * 4)));
      }
